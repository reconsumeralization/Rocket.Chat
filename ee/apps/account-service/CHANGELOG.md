...
- ([#38118](https://github.com/RocketChat/Rocket.Chat/pull/38118)) Fixes an issue where some DDP streamer requests were returning before processing was completed
